...
// Deployed RescueExecutor contract (EIP-7702). Blank = recovery flow shows a
// "not live yet" notice until the contract is deployed + audited.
...
// Project Telegram contacts for support / contact. Both are staffed.
